...
sudo apt-get update
sudo apt-get install -y kubelet=1.28.8-1.1 kubeadm=1.28.8-1.1  kubectl=1.28.8-1.1
...
#containerd --version
sudo curl -L https://github.com/containerd/containerd/releases/download/v1.7.2/containerd-1.7.2-linux-amd64.tar.gz -o containerd-1.7.2-linux-amd64.tar.gz
...
#runc --version
sudo curl -L https://github.com/opencontainers/runc/releases/download/v1.1.7/runc.amd64 -o runc.amd64

sudo install -m 755 runc.amd64 /usr/local/sbin/runc
sudo rm runc.amd64

#Install network plugins
sudo curl -L https://github.com/containernetworking/plugins/releases/download/v1.3.0/cni-plugins-linux-amd64-v1.3.0.tgz -o cni-plugins-linux-amd64-v1.3.0.tgz
...
cd /usr/local/bin/
sudo curl -L https://github.com/projectcalico/calico/releases/download/v3.26.1/calicoctl-linux-amd64 -o calicoctl
