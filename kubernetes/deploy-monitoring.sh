...
helm -n ${NS_MONITORING} template x509-certificate-exporter enix/x509-certificate-exporter -f ../monitoring/x509-certificate-exporter-values.yaml >../kustomize/apps/monitoring/prometheus/x509-certificate-exporter.yaml
