CREATE DATABASE IF NOT EXISTS orchestrator ON CLUSTER analytics;

CREATE TABLE IF NOT EXISTS orchestrator.events ON CLUSTER analytics(
    message String,
...
CREATE TABLE IF NOT EXISTS orchestrator.analytic_case_events ON CLUSTER analytics (
    `inner_data` String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS orchestrator.mv_analytic_case_events ON CLUSTER analytics
...
CREATE TABLE IF NOT EXISTS orchestrator.visitor_countings ON CLUSTER analytics (
    `analytic_type` String,
    `analytic_case_uuid` String,
    `analytic_case_camera_uuid` String,
    `stream_uuid` String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS orchestrator.mv_visitor_countings ON CLUSTER analytics
